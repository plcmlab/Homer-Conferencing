    ...
    PacketStatistic(pName)
{
    ...
    tFormat.Name="SQCIF";      //      128 x  96
    tFormat.ResX = 128;
    tFormat.ResY = 96;
    mSupportedVideoFormats.push_back(tFormat);

    tFormat.Name="QCIF";       //      176 x 144
    tFormat.ResX = 176;
    tFormat.ResY = 144;
    mSupportedVideoFormats.push_back(tFormat);
    ...
    tFormat.Name="EDTV";       //     1280 x 720
    tFormat.ResX = 1280;
    tFormat.ResY = 720;
    mSupportedVideoFormats.push_back(tFormat);

    tFormat.Name="CIF16";      //     1408 x 1152
    tFormat.ResX = 1408;
    tFormat.ResY = 1152;
    mSupportedVideoFormats.push_back(tFormat);
...
string MediaSource::GetGuiNameFromCodecID(enum AVCodecID pCodecId)
{
    ...
    switch(pCodecId)
    {
        ...
        default:
                {
                    const char *tName = HM_avcodec_get_name(pCodecId);
...
void MediaSource::VideoFormat2Resolution(VideoFormat pFormat, int& pX, int& pY)
{
    switch(pFormat)
    {
        ...
        case DVD:        /*      720 x 576       */
                    ...
                    pY = 576;
                    break;
        case CIF9:       /*     1056 x 864       */
                    pX = 1056;
                    pY = 864;
                    break;
        case EDTV:       /*     1280 x 720       */
                    pX = 1280;
                    pY = 720;
                    break;
        case CIF16:      /*     1408 x 1152      */
                    pX = 1408;
                    pY = 1152;
                    break;
        case HDTV:       /*     1920 x 1080       */
                    pX = 1920;
                    pY = 1080;
                    break;
...
bool MediaSource::FfmpegDetectAllStreams(string pSource, int pLine)
{
    ...
    {
        if (mSourceCodecId == AV_CODEC_ID_MPEG2TS)
        {
